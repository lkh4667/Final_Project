...
public class ChallengePageDTO {
	...
	private int blockPage = 3; // 한 블록 보여줄 페이지수
	...
	private int number;
	private int scPage;//successPage
	
	

	public int getScPage() {
		return scPage;
	}


	public void setScPage(int scPage) {
		this.scPage = scPage;
	}
	...
	public ChallengePageDTO() {

	}


	public ChallengePageDTO(int currentPage, int totalCount) {
	...
	public ChallengePageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
